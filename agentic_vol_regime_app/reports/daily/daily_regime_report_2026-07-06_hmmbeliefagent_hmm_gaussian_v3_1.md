...
Date: 2026-07-06T17:30:31.131181+00:00
...
|---|---:|---|
| VIX | 15.88 | Current implied-vol level |
| VVIX | 88.35 | Vol-of-vol state |
| VVIX/VIX | 5.56 | Convexity stress ratio |
| VVIX/VIX z-score | 0.83 | Relative convexity stress |
| VIX term structure (VIX3M) | contango | Front/back of curve |
| Realized vol trend | 0.080 | Short-vs-medium realized vol |
...
- Suggested call overwrite strike: `755.00`
- Suggested DTE: `5`
...
Current-state expected duration: `4.05` days
...
- VOL_EXPANSION or HIGH_VOL within 5d: `0.21`
- VOL_EXPANSION or HIGH_VOL within 10d: `0.26`
- VOL_EXPANSION or HIGH_VOL within 21d: `0.26`
...
|---|---|---:|---:|---:|---|
| HMM v1 Core | MID_VOL_CHOP | 0.90 | 4.05 | 0.03 | LIGHT_OVERWRITE |
| HMM v2 Core + Sector Corr | VOL_EXPANSION | 0.90 | 10.07 | 0.02 | MEDIUM_OVERWRITE |
| HMM v3 Core + Geometry | VOL_EXPANSION | 0.86 | 8.23 | 0.02 | MEDIUM_OVERWRITE |
| HMM v3.1 Meta-Blend | MID_VOL_CHOP | 0.85 | 4.05 | 0.03 | LIGHT_OVERWRITE |
