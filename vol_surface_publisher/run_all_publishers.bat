...
if not defined RESOLVED_MARKET_PRICE_PREFIX if defined MARKET_MANIFOLD_SECTOR_PRICES_GCS_PREFIX set "RESOLVED_MARKET_PRICE_PREFIX=%MARKET_MANIFOLD_SECTOR_PRICES_GCS_PREFIX%"
